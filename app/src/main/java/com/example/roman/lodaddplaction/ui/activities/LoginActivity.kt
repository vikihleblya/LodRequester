...
class LoginActivity : Activity() {
    ...
    private fun login() {
        enableInput(false)
        disposable = loginInteractor.login(LoginRequestDto(et_login.text.toString(), et_password.text.toString()))
                ...
                .subscribe({
                    ...
                    it.printStackTrace()
                    Toast.makeText(baseContext, "Wrong creds", Toast.LENGTH_SHORT).show()
                    enableInput(true)
                })
    }
